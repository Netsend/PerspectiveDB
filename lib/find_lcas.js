...
function findLCAs(sX, sY, opts, cb) {
  ...
  if (rootX) {
    processNext(rootX, xE, indegreeX, outdegreeX, yE, indegreeY, outdegreeY, true);
  ...
  if (rootY) {
    processNext(rootY, yE, indegreeY, outdegreeY, xE, indegreeX, outdegreeX, true);
