 ...
 *
 * opts:
 *   i {Number}  optional offset, valid lbeint
 *   close {Boolean, default false}  optional offset, valid lbeint
 */
Tree.prototype.createReadStream = function createReadStream(opts) {
  ...
  if (typeof opts.close !== 'undefined' && typeof opts.close !== 'boolean') { throw new TypeError('opts.close must be a boolean'); }
  ...
  var r = this.getIKeyRange({ minI: opts.i });
