...
Tree.prototype._composeHeadVal = function _composeHeadVal(item) {
  ...
  try {
    if (typeof item._h.i !== 'number') { throw new TypeError('item._h.i must be a number'); }
  } catch(err) {
    throw new TypeError('item._h.i must be a number');
  }
  ...
  b.writeUIntBE(item._h.i, offset, this._iSize);
