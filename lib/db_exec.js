 ...
 * this handler is setup. So make sure it is setup before startMerge is called
...
function postChroot(cfg) {
  ...
  function handleIncomingMsg(msg, conn) {
    ...
    case 'startMerge':
      ...
      // start auto-merging
      log.warning('DEPRECATED: startMerge is automatically started with the local data handler');
