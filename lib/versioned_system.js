...
function VersionedSystem(oplogColl, opts) {
  ...
  if (typeof opts !== 'undefined') {
    ...
    if (typeof opts.usersColl !== 'undefined' && typeof opts.usersCollName !== 'undefined') { throw new TypeError('opts.usersColl and opts.usersCollName are mutually exclusive'); }
    if (typeof opts.usersColl !== 'undefined' && typeof opts.usersDb !== 'undefined') { throw new TypeError('opts.usersColl and opts.usersDb are mutually exclusive'); }
  }
...
VersionedSystem.prototype._startVC = function _startVC(config, cb) {
  ...
  vc.once('close', function(code, sig) {
