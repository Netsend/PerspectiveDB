...
process.once('message', function(msg) {
  ...
  if (typeof msg.logCfg !== 'undefined' && typeof msg.logCfg !== 'object') { throw new TypeError('msg.logCfg must be an object'); }
  ...
  logCfg.file  = process.stdout;
  logCfg.error = process.stderr;
  logCfg.console = false; // disable output since stdout and stderr are already passed to the logger as file and error params
