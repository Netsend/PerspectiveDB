...
VersionedCollection.prototype._findLCAs = function _findLCAs(itemX, itemY, cb) {
  ...
  stream.on('data', function(item) {
    ...
    that._log.debug2('version:', version, perspective);
    that._log.debug2('START HEADSX', headsX);
    that._log.debug2('START HEADSY', headsY);
    that._log.debug2('START ANCESTORSX', ancestorsX);
    that._log.debug2('START ANCESTORSY', ancestorsY);
    that._log.debug2('START LCAS', lcas);
    that._log.debug2('START CAS', cas);
    ...
    that._log.debug2('END HEADSX', headsX);
    that._log.debug2('END HEADSY', headsY);
    that._log.debug2('END ANCESTORSX', ancestorsX);
    that._log.debug2('END ANCESTORSY', ancestorsY);
    that._log.debug2('END LCAS', lcas);
    that._log.debug2('END CAS', cas);
