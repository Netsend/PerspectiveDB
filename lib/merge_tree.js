 ...
 * to staging and call this._mergeHandler (provided as an option to the
 * constructor). If there is a conflict, skip this head. If a merge is a fast-
 * forward for the local tree, nothing is done.
 *
